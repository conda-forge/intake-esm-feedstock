...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6292&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/intake-esm-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `intake-esm` can be installed with `conda`:
...
```
mamba install intake-esm
```

It is possible to list all of the versions of `intake-esm` available on your platform with `conda`:
...
```
mamba search intake-esm --channel conda-forge
```
...
mamba repoquery search intake-esm --channel conda-forge

# List packages depending on `intake-esm`:
mamba repoquery whoneeds intake-esm --channel conda-forge

# List dependencies of `intake-esm`:
mamba repoquery depends intake-esm --channel conda-forge
```
